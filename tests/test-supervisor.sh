...
# a bare rc is undiagnosable — the revive line must carry the runner's dying words
# (or an explicit empty-log placeholder), never just "rc=137"
assert_contains "sup-revive-surfaces-last-error" "last error:" "$(cat "$TEST_TMPDIR/out1")"
