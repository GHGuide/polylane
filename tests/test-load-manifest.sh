...
assert_eq "int-worktree" "$PROJ/.polylane/wt/integration" "$INT_WORKTREE"
...
assert_eq "lane0-worktree" "$PROJ/.polylane/wt/alpha" "${LANE_WORKTREES[0]}"
...
assert_eq "lane0-pollspec" "alpha:$PROJ/.polylane/wt/alpha" "${LANE_POLLSPEC[0]}"
assert_eq "lane1-pollspec" "beta:$PROJ/.polylane/wt/beta"   "${LANE_POLLSPEC[1]}"
