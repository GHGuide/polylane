...
| --- | --- | --- | --- |
| runner truth | `8df7952` | merged | promotion/report 43/0; liveness/recovery 37/0 |
...
`acceptance=50 pass, 0 fail, 1 unchecked`; `host_rehearsal=not-run`;
...
`self-hosting-truth` layer. The frozen physical GO/NO-GO rehearsal was not run
in this Codex sandbox and is requested exactly once from the coordinator.
