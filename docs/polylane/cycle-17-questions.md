...
- Does the single fresh coordinator terminal matrix pass for
  `c17-recovery-cert-20260809-a1`? Its result alone decides `m16.4` and `m17.3`.
- Is an operator requesting a real 6-, 12-, or 24-hour soak? Accelerated fault evidence
  is complete; elapsed-time certification is optional and never CI work.
- Is any consequential action actually requested? If so, prepare only the exact-hash
  simulation receipt and seek approval; do not execute it.
